...
const MyCourses = () => {
  ...
  return courses ? (
    <div className="flex h-screen flex-col items-start justify-between p-4 pb-0 pt-8 md:p-8 md:pb-0">
            ...
            <tbody className="text-sm text-gray-500">
              {courses.map((course) => (
                <tr key={course._id} className="border-b border-gray-500/20">
                  ...
                  <td className="px-4 py-3">{currency} {Math.floor(course.enrolledStudents.length * (course.coursePrice - (course.coursePrice * course.discount / 100)))}</td>
